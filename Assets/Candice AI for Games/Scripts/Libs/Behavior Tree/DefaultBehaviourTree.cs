...
namespace ViridaxGameStudios.AI
{
    public class DefaultBehaviourTree : MonoBehaviour
    {
        ...
        private BehaviorAction rotateToNode;
        ...
        void Start()
        {
            ...
            rotateToNode = new BehaviorAction(DefaultBehaviors.RotateTo, rootNode);
            ...
            attackSequence.SetNodes(new List<BehaviorNode> {withinAttackRange, rotateToNode, attackNode });
            ...
            patrolSequence.SetNodes(new List<BehaviorNode> { isPatrollingNode, patrolNode, rotateToNode, moveNode });
